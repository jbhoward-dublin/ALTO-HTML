...
<!-- Adapted by J B Howard to XSLT v. 1 with minor formatting changes -->
<!-- captured from https://github.com/altomator/ALTO-HTML/blob/master/XSL/ALTO2HTML.xsl September 2016 -->

<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" 
    xmlns:alto="http://www.loc.gov/standards/alto/ns-v2#"
    xmlns:exsl="http://exslt.org/common"
    xmlns:str="http://exslt.org/strings" extension-element-prefixes="alto str exsl">
    ...
    <xsl:template match="/">
        ...
        <head>
            ...
            <title>Formatted HTML representaiton of ALTO metadata</title> 
        </head>
        <body>
    ...
    <xsl:template match="alto:GraphicalElement">
        ...
        <p class="GraphicalElement"><span class="ge"><xsl:value-of select="@TYPE"/></span></p>
    </xsl:template>    
    ...
    <xsl:template match="alto:ComposedBlock">
        <p class="ComposedBlockDebut"><span class="cb"><xsl:value-of select="@TYPE"/> {</span></p>
        <xsl:apply-templates />
        <p class="ComposedBlockFin"><span class="cb">} <xsl:value-of select="@TYPE"/></span></p>
